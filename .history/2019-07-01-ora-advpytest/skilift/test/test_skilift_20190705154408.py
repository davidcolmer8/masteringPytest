from idlelib.calltip_w import MARK_RIGHT
from logging import makeLogRecord

import pytest
from skilift import Lift, Line, Quad, _Bench
...
@pytest.mark.parametrize('line_size', 'take_count', 'num_people', [(0,5,0)])
def test_line_sizes(line_size, take_count, num_people):
    line = Line(line_size)
    res = line.take(take_count)
    assert line.num_people == num_peopl
